...
1. [User Asset Queries](https://github.com/coinsuperapi/API_docs_en#1user-asset-queries)

   1.1 [Personal Asset Information](https://github.com/coinsuperapi/API_docs_en#11-personal-asset-information)

2. [Transactions](https://github.com/coinsuperapi/API_docs_en#2-transactions)

   2.1 [Place a Buy Order](https://github.com/coinsuperapi/API_docs_en#21-place-a-buy-order)

   2.2 [Place a Sell Order](https://github.com/coinsuperapi/API_docs_en#22-place-a-sell-order)

   2.3 [Cancel Order](https://github.com/coinsuperapi/API_docs_en#23-cancel-order)

   2.4 [Return Order List](https://github.com/coinsuperapi/API_docs_en#24-return-order-list)

   2.5 [Return Order Details](https://github.com/coinsuperapi/API_docs_en#25-return-detailed-order-list)

   2.6 [Pending Order List](https://github.com/coinsuperapi/API_docs_en#26-pending-order-list)

3. [Quotes](https://github.com/coinsuperapi/API_docs_en#3quotes)

   3.1 [Detailed Market Quotes (Top 10%)](https://github.com/coinsuperapi/API_docs_en#31-detailed-market-quote-10)

   3.2 [Detailed Market Quotes (Top 1-50)](https://github.com/coinsuperapi/API_docs_en#32-detailed-market-quote-1-50)

   3.3 [Real Time Price Quotes](https://github.com/coinsuperapi/API_docs_en#33-real-time-price-quotes)

   3.4 [Real-Time Transaction Quotes](https://github.com/coinsuperapi/API_docs_en#34-real-time-transaction-quotes)

   3.5 [Supported Currency Pairs List](https://github.com/coinsuperapi/API_docs_en#35-supported-currency-pairs-list)
